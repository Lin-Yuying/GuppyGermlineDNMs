...
######################################################
#1. trio-based genotyping, GATK, hard filtering and BCFtools
######################################################
#(1) GATK
father=$1
mother=$2
...
######################################################
# AB allel, Depth, etc.
python3 SNPfiltering.py ${prefix}.bcftools.dnm.vcf.gz outDep.txt pedigree.ped
python3 SNPfiltering.py ${prefix}.gatk.snps.vcf.gz outDep.txt pedigree.ped
# remove snps with reads with gaps or without properly mapped mate pair
python3 SNPfiltering.py ${prefix}.AB_DP.bcftools.vcf.gz pedigree.ped
python3 SNPfiltering.py ${prefix}.AB_DP.gatk.vcf.gz pedigree.ped
